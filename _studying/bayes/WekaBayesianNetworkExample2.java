...
public class WekaBayesianNetworkExample2 {
...
//        bayesNet.addNode("Burglary", 2);
//        bayesNet.addNode("Earthquake", 2);
//        bayesNet.addNode("Alarm", 2);
//        bayesNet.addNode("JohnCalls", 2);
//        bayesNet.addNode("MaryCalls", 2);

        bayesNet.addArc("Burglary", "Alarm");
        bayesNet.addArc("Earthquake", "Alarm");
        bayesNet.addArc("Alarm", "JohnCalls");
        bayesNet.addArc("Alarm", "MaryCalls");

//        bayesNet.initStructure(); // Reseted
//        bayesNet.buildStructure(); // Exception
