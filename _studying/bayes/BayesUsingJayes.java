...
public class BayesUsingJayes {
    ...
    public static class BurglaryCalculator {
        public static Map<String, Double> burglaryTT = new HashMap<String, Double>();
        /**
         * Storing the values provided in Bayesian Network for Burglary
         */
        public static Map<String, Double> earthquakeTT = new HashMap<String, Double>();
        /**
         * Storing the values provided in Bayesian Network for Earthquake
         */
        public static Map<String, Double> alarmTT = new HashMap<String, Double>();
        /**
         * Storing the values provided in Bayesian Network for Alarm
         */
        public static Map<String, Double> johnCallTT = new HashMap<String, Double>();
        /**
         * Storing the values provided in Bayesian Network for JohnCall
         */
        public static Map<String, Double> maryCallTT = new HashMap<String, Double>();
        /**
         * Storing the values provided in Bayesian Network for MaryCall
         */
        public static Map<Character, ArrayList<Character>> conditions, givenValues;
